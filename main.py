...
# # char_file = open('/home/luwei/code/image-ids-CTR/CCR_CLIP/data/all_chinese.txt', 'r').read()
char_file = open('/home/yuhaiyang/CLIP-OCR/data/char_3755.txt', 'r').read()
char_3755 = list(char_file)
tmp_text_t = convert(char_3755)
...
# model = CLIP(embed_dim=2048, context_length=config['max_len'],
#             vocab_size=int(torch.max(tmp_text_t))+1, transformer_width=512,
#              transformer_heads=8, transformer_layers=12).cuda()
...
#         # print('logit_scale.tolist()', logit_scale.tolist())
#         logits_per_image = logit_scale * image_features @ text_features.t()
