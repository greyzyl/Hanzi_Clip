...
class ResNet(nn.Module):
    ...
    def __init__(self, num_in, block, layers, embed_dim):
        ...
        # self.image_projection = nn.Parameter(torch.empty(1024, embed_dim))
        self.image_projection = nn.Linear(1024, embed_dim)
...
if __name__ == '__main__':
    encoder = ResNet(num_in=3, block=BasicBlock, layers=[3,4,6,3])
